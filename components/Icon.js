...
const paths = {
  ...
  oncology: (
    <>
      ...
      <path d="M12 8V3M9.5 5h5" />
    </>
  ),
  cardiology: (
    <>
      <path d="M20.4 6.6a4.6 4.6 0 0 0-6.5 0L12 8.5l-1.9-1.9a4.6 4.6 0 1 0-6.5 6.5L12 21l8.4-7.9a4.6 4.6 0 0 0 0-6.5z" />
      <path d="M3 13h4l1.5-2.5L10 15l1.5-3 1 1.5H17" />
    </>
  ),
  orthopedic: (
    <>
      <path d="M7 4a2.5 2.5 0 0 0-2 4 2.5 2.5 0 0 0 1 4l4 4a2.5 2.5 0 0 0 4 1 2.5 2.5 0 0 0 4-2" />
      <path d="M17 20a2.5 2.5 0 0 0 2-4 2.5 2.5 0 0 0-1-4l-4-4a2.5 2.5 0 0 0-4-1 2.5 2.5 0 0 0-4 2" />
    </>
  ),
  neurosurgery: (
    <>
      <path d="M9 3a4 4 0 0 0-4 4 3 3 0 0 0-1 5 3 3 0 0 0 2 5 3.5 3.5 0 0 0 6 1V4a3 3 0 0 0-3-1z" />
      <path d="M15 3a4 4 0 0 1 4 4 3 3 0 0 1 1 5 3 3 0 0 1-2 5 3.5 3.5 0 0 1-6 1" />
    </>
  ),
  urology: (
    <>
  ...
  gastroenterology: (
    <>
      ...
      <path d="M5 8h3M16 21h3" />
      <circle cx="12" cy="8" r="0.6" fill="currentColor" />
    </>
  ),
  "plastic-surgery": (
    <>
      <path d="M12 3l2.1 4.6 5 .6-3.7 3.4 1 4.9L12 14l-4.4 2.5 1-4.9L4.9 8.2l5-.6L12 3z" />
      <path d="M6 20h12" />
    </>
  ),
  ophthalmolog: (
  ...
  endocrinologists: (
    <>
      <path d="M9 4c0 3 6 3 6 6s-6 3-6 6 6 3 6 4" />
      <path d="M7 4h10M7 20h10" />
    </>
  ),
  "ent-doctors": (
    <>
      <path d="M8 20c0-3-3-4-3-8a7 7 0 0 1 14 0c0 2-1 3-2 3s-2-1-2-2a3 3 0 1 0-3 3" />
      <path d="M11 16c0 2-1 3-3 4" />
    </>
  ),
  hematology: (
    <>
  ...
  doctor: (
    <>
      ...
      <path d="M12 14v4M10.5 16h3" />
    </>
  ),
  microscope: (
    <>
      <path d="M9 4h4l1 6h-6l1-6z" />
      <path d="M7 16a5 5 0 0 0 10 0" />
      <path d="M4 21h16M11 16v5" />
    </>
  ),
  compass: (
    <>
