...
const about = {
  ...
  advantages: [
    { ru: "Компетентные и опытные специалисты, прошедшие подготовку в престижных медицинских учреждениях мира.", en: "Competent and experienced specialists trained in the world's most prestigious medical institutions." },
    { ru: "Инновационное и лучшее в мире оборудование.", en: "Innovative, best-in-class equipment." },
    { ru: "Индивидуальный подход к каждому пациенту и подбор оптимальной программы лечения.", en: "An individual approach to each patient and the most suitable treatment programme." },
    { ru: "Отличные условия пребывания — чтобы пациент чувствовал себя как дома.", en: "Excellent conditions so patients feel at home during their stay." },
  ],
};
